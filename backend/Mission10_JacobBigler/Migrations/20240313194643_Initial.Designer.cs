...
namespace Mission10_JacobBigler.Migrations
{
    ...
    [Migration("20240313194643_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mission10_JacobBigler.Models.Bowler", b =>
                {
            ...
            modelBuilder.Entity("Mission10_JacobBigler.Models.BowlerScore", b =>
                {
            ...
            modelBuilder.Entity("Mission10_JacobBigler.Models.MatchGame", b =>
                {
                    b.Property<int>("MatchId")
                        .HasColumnType("INT")
                        .HasColumnName("MatchID");
            ...
            modelBuilder.Entity("Mission10_JacobBigler.Models.Team", b =>
                {
                    b.Property<int>("TeamId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
            ...
            modelBuilder.Entity("Mission10_JacobBigler.Models.Tournament", b =>
                {
            ...
            modelBuilder.Entity("Mission10_JacobBigler.Models.TourneyMatch", b =>
                {
                    b.Property<int>("MatchId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
            ...
            modelBuilder.Entity("Mission10_JacobBigler.Models.ZtblBowlerRating", b =>
                {
            ...
            modelBuilder.Entity("Mission10_JacobBigler.Models.ZtblSkipLabel", b =>
                {
            ...
            modelBuilder.Entity("Mission10_JacobBigler.Models.ZtblWeek", b =>
                {
            ...
            modelBuilder.Entity("Mission10_JacobBigler.Models.Bowler", b =>
                {
                    b.HasOne("Mission10_JacobBigler.Models.Team", "Team")
                        .WithMany("Bowlers")
            ...
            modelBuilder.Entity("Mission10_JacobBigler.Models.BowlerScore", b =>
                {
                    b.HasOne("Mission10_JacobBigler.Models.Bowler", "Bowler")
            ...
            modelBuilder.Entity("Mission10_JacobBigler.Models.MatchGame", b =>
                {
                    b.HasOne("Mission10_JacobBigler.Models.TourneyMatch", "Match")
                        .WithMany("MatchGames")
            ...
            modelBuilder.Entity("Mission10_JacobBigler.Models.TourneyMatch", b =>
                {
                    b.HasOne("Mission10_JacobBigler.Models.Team", "EvenLaneTeam")
                        .WithMany("TourneyMatchEvenLaneTeams")
                        .HasForeignKey("EvenLaneTeamId");

                    b.HasOne("Mission10_JacobBigler.Models.Team", "OddLaneTeam")
                        .WithMany("TourneyMatchOddLaneTeams")
                        .HasForeignKey("OddLaneTeamId");

                    b.HasOne("Mission10_JacobBigler.Models.Tournament", "Tourney")
